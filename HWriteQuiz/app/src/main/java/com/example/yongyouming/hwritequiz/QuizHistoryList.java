...
public class QuizHistoryList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_quiz = (ListView) findViewById(R.id.lv_quizPast);
        setParas();
        webapi = new WebApi();

        QuizList = new ArrayList<QuizesModel>();
        AddtoList(webapi.GET("QuizsApi/GetQuizPart?status=0&qid=&token=&cid="+cid));
    ...
    void CheckQuiz(int qid)
    {
        ...
        it_go.setClass(QuizHistoryList.this,QuizDetail.class);
        startActivity(it_go);
    }
    ...
    void AddtoList(String jsonstring) {
        try {
            ...
            e.printStackTrace();
            Toast.makeText(QuizHistoryList.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
